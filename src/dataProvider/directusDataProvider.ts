...
export const directusDataProvider = (apiBaseUrl: string, httpClient = fetchUtils.fetchJson): DataProvider => ({
  ...
  update: (resource, params) =>
    httpClient(`${getDirectusEndpoint(resource, apiBaseUrl)}/${params.id}`, {
      method: "PATCH",
...
const getDirectusFieldsEndpoint = (resource: string, apiBaseUrl: string) => {
  return `${apiBaseUrl}/fields/${resource}`;
};
