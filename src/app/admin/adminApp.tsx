...
const AdminApp = () => (
  <Box>
    ...
    <Box sx={{ marginTop: "20px" }}>
      This area will allow creation, deletion and updating of things all items
      by Admins, including system data like values in dropdowns, anzscis etc.
      <br />
      It will only be visiible to approved users.
    </Box>
  </Box>
);
