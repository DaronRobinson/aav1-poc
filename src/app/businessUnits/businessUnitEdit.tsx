    ...
    <Grid item xs={6} sm={9}>
      ...
      <Edit>
        <SimpleForm sx={{ padding: "30px 50px" }}>
          ...
          <BooleanInput source="is_head_office" />
          <ReferenceInput source="addresses" reference="addresses">
            <AutocompleteInput label="Addresses" sx={{ width: "100%" }} />
          </ReferenceInput>
          <span>
            ^ Not the right widget here : We need the enterprise version to
            support <strong>one-to-many</strong> relationships in the form
            easily
          </span>
          <br />
        </SimpleForm>
